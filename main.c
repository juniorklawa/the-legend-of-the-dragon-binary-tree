...
int main() {
    ...
    chapter3->left = newNodeEndOfChapter(12, key12Description, "", NULL);
    chapter3->right = newNode(13, key13Description);
    chapter3->right->left = newNodeEndOfChapter(15, key15Description, "", NULL);
    chapter3->right->right = newNodeEndOfChapter(16, key16Description, "", challenge1);


    //CHAPTER 4
    struct Node *chapter4 = newNode(17, key17Description);
    chapter4->left = newNodeEndOfChapter(18, key18Description, "", challenge2);
    chapter4->right = newNodeEndOfChapter(19, key19Description, "", challenge3);
    ...
    chapter5->left->left = newNodeEndOfChapter(25, key25Description, "", NULL);
    chapter5->left->right = newNodeEndOfChapter(26, key26Description, "", challenge4);
    chapter5->right->left = newNodeEndOfChapter(27, key27Description, "", challenge5);
    chapter5->right->right = newNodeEndOfChapter(28, key28Description, "", NULL);

    //CHAPTER 6
    struct Node *chapter6 = newNode(29, key29Description);
    chapter6->left = newNodeEndOfChapter(30, key30Description, "", challenge6);
    chapter6->right = newNodeEndOfChapter(31, key31Description, "", NULL);
    ...
    chapter8->left = newNodeEndOfChapter(41, key41Description, "", NULL);
